...
Mathematisch wird das Graph Coloring als Abbildung $c$ von der Menge $V(G)$ als Knoten auf eine Menge $C$ als Farben für einen Graphen $G$ definiert \parencite[121]{Diestel2017-bj}.
\begin{equation*}
c(v): V(G) \rightarrow C 
\end{equation*}
\begin{equation*}
...
% \;\; ,\text{wobei}\; \forall \{a,b\} \in E(G) \colon \; c(a) \overset{!}{\neq} c(b)
