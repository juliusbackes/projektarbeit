...
<nav class="w-full h-20  flex items-center justify-between px-3 md:px-10 border-b border-emerald-700/50">
    ...
    <DropdownMenu.Root>
        <DropdownMenu.Trigger>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-10 text-emerald-700">
...
<section class="bg-gray-200/50 md:p-8 min-h-screen p-4">
    <div class="md:max-w-[1200px] mx-auto mt-3">
        {@render children()}
    </div>
</section>

{#snippet settingsIconNav()}
